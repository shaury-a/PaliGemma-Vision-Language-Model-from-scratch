...
class GemmaRMSNorm(nn.Module):
    def __init__(self, dim: int, eps: float = 1e-6):
        super().__init__()
        self.eps = eps # when denominator->0, to keep it stable
...
class GemmaRotaryEmbedding(nn.Module):
    ...
    def forward(self, x, position_ids, seq_len=None):
        ...
        with torch.autocast(device_type=device_type, enabled=False):#disabling mixed precision for more precise calculations
    ...
    def forward(
        ...
        **kwargs,
        ...
        if kv_cache is not None:
            ...
            #updates he key value cache, but return whole key, value cache
