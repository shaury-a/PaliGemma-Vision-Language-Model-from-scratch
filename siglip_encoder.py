...
class SiglipVisionEmbeddings(nn.Module):
    def __init__(self, config: SiglipVisionConfig):
        ...
        # (w-k+2p/s) +1 = 224-16/16 +1 = 14 = Num_Patches_W = width // patch_size

        self.num_patches = (self.image_size // self.patch_size) ** 2 # (14x14)
        self.num_positions = self.num_patches
        self.position_embedding = nn.Embedding(self.num_positions, self.embed_dim) #just a wrapper around linear layer
